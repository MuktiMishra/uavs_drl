...
def detailed_train_with_loss_tracking():
    ...
    torch.save(model.state_dict(), "model_output/uav_diagnostic_model_v2.pth")
    ...
    print(f"Training results saved to model_output/uav_training_results_v2.csv")

    return results_df

# --- Plotting Function ---
def plot_training_results(results_path="model_output/uav_training_results_v2.csv",
...
def run_simulation_and_get_trajectory(model_path="model_output/uav_diagnostic_model_v2.pth"):
    """
...
if __name__ == "__main__":
    ...
    results_file = "model_output/uav_training_results_v2.csv"
    model_file = "model_output/uav_diagnostic_model_v2.pth"
